# -*- coding: utf-8 -*-
# Generated by Django 1.11.26 on 2019-11-29 16:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stype', models.CharField(choices=[('like', '右滑：喜欢'), ('superlike', '上滑：超级喜欢'), ('dislike', '左滑：不喜欢')], max_length=10, verbose_name='滑动类型')),
